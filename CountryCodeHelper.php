...
class CountryCodeHelper{
	public static $country_data = NULL;
	public static $country_codes = NULL;
	public static $country_names = NULL;
	public static $country_dial_codes = NULL;
	
	public static function initCountryData(){
		if(CountryCodeHelper::$country_data == NULL){
			 CountryCodeHelper::$country_data = array(
	...
	public static function findAllCountryCodes(){
		...
		if(CountryCodeHelper::$country_codes == NULL){
			...
			foreach(CountryCodeHelper::$country_data as $country_datom){
				CountryCodeHelper::$country_codes[$i ] = $country_datom["code"];
				$i++;
			} 
		}
	...
	public static function findAllCountryNames(){
		...
		if(CountryCodeHelper::$country_names == NULL){
			...
			$i = 0;
			foreach(CountryCodeHelper::$country_data as $country_datom){
				CountryCodeHelper::$country_names[$i ] = $country_datom["name"];
				$i++;
			} 
		}
	...
	public static function findAllCountryDialCodes(){
		...
		if(CountryCodeHelper::$country_dial_codes == NULL){
			...
			$i = 0;
			foreach(CountryCodeHelper::$country_data as $country_datom){
				CountryCodeHelper::$country_dial_codes[$i ] = $country_datom["d_code"];
				$i++;
			} 
		}
